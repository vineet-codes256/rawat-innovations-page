...
export default function HomePage() {
  ...
  return (
    <>
      ...
      >
        {/* Header / Navigation */}
        <header className="fixed rounded-full ml-[5%] w-[90%] top-1 z-50 bg-white/20 backdrop-blur-md border-b border-gray-200 shadow-sm" role="banner">
            ...
            <div className="flex items-center justify-between">
              ...
              >
                <Image
                  ...
                  priority
                />
                <span className="text-xl font-bold text-blue-900 md:hidden" aria-label="Rawat Innovations Pvt Ltd">RIPL</span>
                <span className="text-xl font-bold text-blue-900 hidden md:block cursor-default" aria-label="Rawat Innovations Pvt Ltd">Rawat Innovations</span>
              </motion.div>
        ...
        <main id="main-content">
          {/* Hero Section */}
          <section id="home" className="pt-24 pb-20 relative overflow-hidden" aria-labelledby="hero-heading">
            <div className="container mx-auto px-6">
              ...
              >
                ...
                <motion.h1
                  id="hero-heading"
                  className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent leading-tight"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.2, duration: 0.8 }}
                  tabIndex={-1}
                >
                  Innovating Today for a<br className="hidden sm:block" /> Smarter Tomorrow
                </motion.h1>
              ...
              >
                <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 text-center">
                  ...
                  <p className="text-sm text-gray-500">
                    Visionary leader with expertise in technology innovation and entrepreneurial ventures.
                    Handling all aspects of technology innovation, from software development to business strategy.
                  </p>
                </div>
              </motion.div>
            </div>
        ...
        <section id="services" className="py-20 bg-blue-50/50">
          <div className="container mx-auto px-6">
            <motion.div
              ...
              className="text-center mb-16"
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-blue-900">Our Sectors</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                We operate across six dynamic sectors, each representing our commitment to innovation and excellence.
              </p>
            </motion.div>
        ...
        <section id="portfolio" className="py-20 bg-white">
          <div className="container mx-auto px-6">
            <motion.div
              ...
              className="text-center mb-16"
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-blue-900">Our Vision</h2>
              ...
              {[
                {
                  ...
                  category: "Social",
                  description: "Location-based discovery social media app connecting people through shared experiences and local communities.",
                  status: "Development",
                ...
                },
                {
                  ...
                  category: "Software",
                  description: "Revolutionary analytics platform using machine learning for business intelligence.",
                  status: "Planning",
                ...
                },
                {
                  ...
                  category: "Gaming",
                  description: "Virtual reality training solutions for professional skill development.",
                  status: "Research",
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className={`text-sm font-medium px-3 py-1 rounded-full ${
                        project.status === 'Planning' ? 'text-orange-600 bg-orange-100' :
                        project.status === 'Research' ? 'text-purple-600 bg-purple-100' :
                        project.status === 'Design' ? 'text-green-600 bg-green-100' :
        ...
        <section id="blog" className="py-20 bg-blue-50/50">
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Stay updated with the latest trends, insights, and thought leadership from Vineet Rawat.
              </p>
            </motion.div>
                ...
                {[
                  {
                    ...
                    excerpt: "How artificial intelligence is transforming traditional farming practices...",
                  ...
                  },
                  {
                    ...
                    excerpt: "Exploring how tech is enhancing travel experiences worldwide...",
                  ...
                  },
                  {
                    ...
                    excerpt: "How technology is driving eco-friendly fashion innovation...",
            ...
            >
              ...
              <p className="text-gray-700 mb-6">
                Subscribe to our newsletter for the latest insights on technology innovation and industry trends.
              </p>
        ...
        <section id="careers" className="py-20 bg-white">
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
                Currently a solo operation led by Vineet Rawat. Future opportunities will be posted as we grow.
              </p>
            </motion.div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              >
                ...
                <p className="text-gray-700 mb-6">
                  Rawat Innovations is currently a one-person operation where Vineet Rawat handles all aspects of the business.
                  As we grow and expand our moonshot projects, we&apos;ll be looking for passionate innovators to join our journey.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100">
                    ...
                    <p className="text-gray-700 mb-4">
                      Follow our journey and be the first to know when opportunities arise.
                    </p>
        ...
        <section id="contact" className="py-20 bg-blue-50/50">
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Ready to start your innovation journey? Get in touch with Vineet Rawat.
              </p>
            </motion.div>
          ...
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
              ...
              <div className="md:col-span-2">
                ...
                <p className="text-blue-100 mb-4 max-w-md">
                  Building moonshot products that drive innovation across software, gaming, tourism, agritech, apparel, and digital services.
                </p>
                <div className="flex space-x-4">
                  {[
                    { icon: '/social-linkedin.png', url: 'https://www.linkedin.com/company/rawat-innovations-pvt-ltd' },
            ...
            <div className="border-t border-blue-800 pt-8 text-center">
              <p className="text-blue-200">
                &copy; 2025 Rawat Innovations Pvt. Ltd. All rights reserved. Building the future, one innovation at a time.
              </p>
            </div>
          </div>
        </footer>
